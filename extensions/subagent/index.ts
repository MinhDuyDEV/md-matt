...
async function runSingleAgent(
	...
	args.push("--thinking", inheritedThinking);
...
export default function (pi: ExtensionAPI) {
	pi.registerTool({
		...
		label: "Subagent",
		description: [
			"Delegate tasks to specialized child Pi processes with isolated context.",
					...
					if (!ctx.hasUI) {
						return {
							content: [
								{
									type: "text",
									text: "Refused: project-local agents require interactive confirmation and cannot run in this mode.",
								},
							],
